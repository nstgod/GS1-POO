...
public class SensorRadiacao extends ComponenteEspacial implements Sensor {
    ...
    private double limiteAlerta;   // acima desse valor (em µSv/h) deve disparar alerta
    ...
    public SensorRadiacao(String id, String nome, double limiteAlerta) {
        ...
        super(id, nome, 18 + Math.random() * 10);
    ...
    public double lerValor() {
        // Simula uma leitura de radiação entre 0 µSv/h e 100 µSv/h
    ...
    public String exibirStatus() {
        return "Sensor de " + retornarTipo()
                + " [" + getStatus() + "]"
                + " | Limite de alerta: " + limiteAlerta + " uSv/h"
